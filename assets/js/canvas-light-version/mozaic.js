	...
	;function mozaic(){
		var canv = document.getElementById('canvas-animation'),
		    ...
		    opts = {
		      ...
		      colors: [ 'rgba(255,38,83,alp)', 'rgba(255,38,83,alp)', 'rgba(10,150,204,alp)' ], // Colors for the dots
		      
		      addedAlpha: 20,
		      strokeColor: 'rgb(230,230,230)', // Color for the dots's sides
		...
		function loop(){
		  ...
		  ctx.shadowBlur = 0;
		  ctx.fillStyle = 'rgba(250,250,251,alp)'.replace( 'alp', opts.repaintAlpha ); // Color for the background
