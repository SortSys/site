	...
	;function mozaic(){
		var canv = document.getElementById('canvas-animation'),
		    ...
		    opts = {
		      ...
		      colors: [ 'rgba(229,34,75,alp)', 'rgba(191,28,62,alp)', 'rgba(10,150,204,alp)' ], // Colors for the dots
		      
		      addedAlpha: 20,
		      strokeColor: 'rgb(24,20,26)', // Color for the dots's sides
		...
		function loop(){
		  ...
		  ctx.shadowBlur = 0;
		  ctx.fillStyle = 'rgba(16,2,5,alp)'.replace( 'alp', opts.repaintAlpha ); // Color for the background
