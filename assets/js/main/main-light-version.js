		...
		if(!window.isMobile){
			if(canvasAnimation[0]){
				...
				if(canvasAnimation[1] == 'bubbles'){
					...
					particlesJS.load('el-bg-block', '../assets/js/canvas-light-version/particles-settings/particles-bubbles.json', function() {});
				}

				if(canvasAnimation[1] == 'particles-default'){
					
					particlesJS.load('el-bg-block', '../assets/js/canvas-light-version/particles-settings/particles-default.json', function() {});
				}

				if(canvasAnimation[1] == 'particles-snow'){
					
					particlesJS.load('el-bg-block', '../assets/js/canvas-light-version/particles-settings/particles-snow.json', function() {});
				}
				...
				if(canvasAnimation[1] == 'particles-to-up'){
					...
					particlesJS.load('el-bg-block', '../assets/js/canvas-light-version/particles-settings/particles-to-up.json', function() {});
				}
